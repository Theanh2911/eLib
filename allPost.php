                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            foreach($list as $ls){
                                                ...
                                                $role = getRoleByUser($ls['createdBy']);
                                                if($role != 'user'){
                                                    $row .= '<td><a href="update.php?id='.$ls['id'].'">sửa</a></td>';
                                                }
                                                else{
                                                    $row .= '<td></td>';
                                                }
                                                $row .= '<td><a href="Comment.php?id='.$ls['id'].'">xem</a></td>';        
                                                        
                                                if($ls['daduyet'] === '0'){
                                                   $row.= '<td><a href="updateStatus.php?id='.$ls['id'].'">Duyệt bài</a></td>';
                                                }
                                                $row.= '</tr>';
                                                echo $row;
                                            }
